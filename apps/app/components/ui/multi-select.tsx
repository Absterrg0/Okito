				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex p-1 rounded-md  min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
												...
												<CommandItem
													...
													<div
														className={cn(
															...
															isSelected
																? "bg-accent-sidebar text-background"
