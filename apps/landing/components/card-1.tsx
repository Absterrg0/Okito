  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-32 bg-gradient-to-r from-emerald-500/3 to-teal-500/3 blur-3xl group-hover:from-emerald-500/6 group-hover:to-teal-500/6 transition-all duration-700"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        >
          <div className="flex items-center gap-4">
            <div
              className="relative p-3 bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-xl border border-emerald-400/30 shadow-lg shadow-emerald-500/10"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-xl"></div>
          ...
          <div
            className="px-3 py-1 bg-emerald-500/10 border border-emerald-400/30 rounded-full hover:bg-emerald-500/20 hover:border-emerald-400/50 transition-all duration-300"
          >
        ...
        <div className="grid grid-cols-5 gap-6">
          ...
          <div className="col-span-2 space-y-4">
            ...
            >
              <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-lg opacity-0 group-hover/input:opacity-100 transition-opacity duration-300 blur-sm"></div>
          ...
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-xl opacity-0 group-hover/code:opacity-100 transition-opacity duration-500 blur-sm"></div>
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className="text-xs text-gray-400 bg-slate-800/50 px-2 py-1 rounded border border-emerald-500/20 hover:border-emerald-500/30 transition-colors duration-300"
                >
                  SDK v2.1.0
                </div>
              </div>
              ...
              >
                <div className="flex-1 h-1.5 bg-slate-700/50 rounded-full overflow-hidden border border-emerald-500/10">
                  <motion.div
                    className="h-full bg-gradient-to-r from-emerald-400 via-teal-400 to-emerald-400 group-hover/code:shadow-[0_0_10px_rgba(16,185,129,0.5)] transition-all duration-300"
                    initial={{ width: "75%" }}
                ...
                <div
                  className="p-1.5 bg-emerald-500/20 rounded-full border border-emerald-400/30 hover:bg-emerald-500/30 hover:border-emerald-400/50 transition-all duration-300"
                >
